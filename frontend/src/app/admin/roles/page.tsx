...
import { Plus, Edit, Trash2, MoreHorizontal, SlidersHorizontal, ChevronDown } from "lucide-react";
...
export default function RolesPage() {
  ...
  const handleSortChange = (key: "role_name" | "id", direction: "asc" | "desc") => {
    setSortKey(key);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-lg border transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
        ...
        <div className="flex items-center space-x-2">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-[200px]">
              <DropdownMenuItem onClick={() => handleSortChange("role_name", "asc")}>
                Name (A-Z)
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => handleSortChange("role_name", "desc")}>
                Name (Z-A)
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              ...
              <DropdownMenuItem onClick={() => handleSortChange("id", "desc")}>
                ID (High to Low)
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
          ...
          <TableHeader>
            <TableRow>
              <TableHead
                ...
                onClick={() => handleSortChange("id", sortDirection === "asc" ? "desc" : "asc")}
              >
                ID {sortKey === "id" && (sortDirection === "asc" ? "↑" : "↓")}
              </TableHead>
              <TableHead
                className="text-left font-semibold text-gray-700 cursor-pointer py-3 px-4 hover:bg-gray-100 transition-colors duration-300"
                onClick={() => handleSortChange("role_name", sortDirection === "asc" ? "desc" : "asc")}
              >
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={(open) => setIsDeleteDialogOpen(open)}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleDeleteRole} className="bg-red-600 text-white hover:bg-red-800">
              Delete
            </Button>
          </DialogFooter>
        </DialogContent>
